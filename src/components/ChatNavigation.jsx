...
const ChatNavigation = ({ activeLink, setActiveLink }) => {
    ...
    return (
        <div className={`h-20 w-full ${activeLink == 'finChat' && 'hidden'} bg-white absolute right-0 left-0 bottom-0 mt-auto flex ch:flex-1 shadow-border ch:text-center items-center justify-evenly z-[9999]`}>
